...
T = TypeVar("T", bound="GetByOrgByRepoResponse200")



@_attrs_define
class GetByOrgByRepoResponse200:
    """ 
        Attributes:
            id (str):
            org (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_upstream(data: object) -> GetByOrgByRepoResponse200UpstreamType0 | None:
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                upstream_type_0 = GetByOrgByRepoResponse200UpstreamType0.from_dict(data)
                ...
                pass
            return cast(GetByOrgByRepoResponse200UpstreamType0 | None, data)

        upstream = _parse_upstream(d.pop("upstream"))


        get_by_org_by_repo_response_200 = cls(
            id=id,
            org=org,
            name=name,
            default_branch=default_branch,
        ...
        get_by_org_by_repo_response_200.additional_properties = d
        return get_by_org_by_repo_response_200
