...
class GetByOrgByRepoContentResponse200Type2:
    ...
    sha: str
    child_count: int
    entries: list[GetByOrgByRepoContentResponse200Type2EntriesItemType0 | GetByOrgByRepoContentResponse200Type2EntriesItemType1 | GetByOrgByRepoContentResponse200Type2EntriesItemType2]
    next_cursor: None | str
    has_more: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for entries_item_data in (_entries):
            def _parse_entries_item(data: object) -> GetByOrgByRepoContentResponse200Type2EntriesItemType0 | GetByOrgByRepoContentResponse200Type2EntriesItemType1 | GetByOrgByRepoContentResponse200Type2EntriesItemType2:
                try:
